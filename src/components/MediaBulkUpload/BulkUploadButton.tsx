        ...
        >
          <div>
            ...
            <div style={{ marginTop: '4px', color: '#6b7280', fontSize: '13px' }}>
              {queue.length} image(s), {selectedCount} selected
            </div>
          </div>
    ...
    <div style={{ marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
          ...
          <span style={{ color: '#9ca3af', fontSize: '13px' }}>
            {isDragging
              ...
              : 'Drop a folder or multiple images here. Folders are parsed into image files.'}
          </span>
        </div>
      </div>
      ...
      {!MEDIA_PRE_EDIT_ENABLED && queue.length > 0 && (
        ...
        >
          ...
          >
            <strong style={{ fontSize: '13px' }}>{queue.length} image(s) ready</strong>
